...
@section('content')  <!-- layouts.appのyieldの中に入るcontent -->
...
<div class="container">
  ...
  <div class="menu-items row text-center">
    ...
    <?php foreach ($products as $product): ?>
      <div class="card col-3.5 m-3" style="border: double 5px #4ec4d3;">
        <img src="{{ $product->picture_path }}" class="menu-item-image img-responsive" style="height:250px">  <!-- ディレクトリ構造の違いによりimgのパスがfindと違うので注意 -->
        <div class="card-body">
