  ...
  <div class="form-group row mx-auto container mt-5">
    ...
    <div class="form-group row mx-auto container mt-5">
      <label for="inputZip" class="col-sm-5 col-form-label">郵便番号</label>
        <div class="col-sm-7">
          <input id="zip01" type="text" name="zip01" size="10" maxlength="8" onKeyUp="AjaxZip3.zip2addr(this,'','pref01','addr01');" value="{{ old('zip01') }}" class="form-control form-control{{ $errors->has('zip01') ? ' is-invalid' : '' }}" required integer autofocus>
  ...
  <div class="modal-dialog" role="document">
    ...
    <div class="form-group row mx-auto container mt-5">
      <label for="inputState" class="col-sm-5 col-form-label">都道府県</label>
        <div class="col-sm-7">
          <input id="pref01" type="text" name="pref01" size="20" value="{{ old('pref01') }}" class="form-control form-control{{ $errors->has('pref01') ? ' is-invalid' : '' }}" required autofocus>
    ...
    <div class="form-group row mx-auto container mt-5">
      <label for="inputCity" class="col-sm-5 col-form-label">市区町村</label>
        <div class="col-sm-7">
          <input id="addr01" type="text" name="addr01" size="60" value="{{ old('addr01') }}" class="form-control form-control{{ $errors->has('addr01') ? ' is-invalid' : '' }}" required autofocus>
    ...
    <div class="form-group row container mt-5 mx-auto">
      ...
      <div class="modal_wrap">
        <input id="trigger" type="checkbox">
          ...
          <label id="check-info" class="open_button btn btn-primary">購入確定ページへ</label>
