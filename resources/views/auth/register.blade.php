      ...
      <div class="card" style="border: double 5px #5c9ee7;">
        ...
        <div class="card-body">
          <form method="POST" action="{{ route('register') }}">
            ...
            <div class="form-group row">
            <p class="col-md-4 col-form-label text-md-right">利用規約</p>
              <input class="col-md-4" type="textarea" name="" placeholder="利用規約
この利用規約（以下，「本規約」といいます。）は，Team34（以下，「当社」といいます。）がこのウェブサイト上で提供するサービス（以下，「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。
第1条（適用）
...
以上">
            ...
            <div class="form-group row">
              <p class="col-md-4 col-form-label text-md-right">利用規約を確認 </p>
              <input class="col-md-1" type="checkbox" required>
            </div>
